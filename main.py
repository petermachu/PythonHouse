...
pool_room.set_description("A big bright room with red carpet with spilled orange juice on it.")
...
pool_room.link_room(ballroom, "below")
ballroom.link_room(pool_room, "up")
